...
public class TestDataReaderSun1_4_0 {
   ...
   /**
    ...
    public void testParse1() throws Exception {
        ...
        AbstractGCEvent<GCEvent> event1 = new GCEvent(0, 8968, 8230, 10912, 0.0037192d, Type.GC);
        event1.getGeneration();
        AbstractGCEvent<GCEvent> event2 = new GCEvent(1, 8968, 8230, 10912, 0.0037192d, Type.GC);
        event2.getGeneration();
        AbstractGCEvent<GCEvent> event3 = new GCEvent(2, 8968, 8230, 10912, 0.0037192d, Type.GC);
        event3.getGeneration();
        AbstractGCEvent<GCEvent> event4 = new GCEvent(3, 10753, 6046, 10912, 0.3146707d, Type.FULL_GC);
        event4.getGeneration();
        AbstractGCEvent<GCEvent> event5 = new GCEvent(4, 10753, 6046, 10912, 0.3146707d, Type.INC_GC);
        event5.getGeneration();
        AbstractGCEvent<GCEvent> event6 = new GCEvent(5, 52471, 22991, 75776, 1.0754938d, Type.GC);
    ...
    public void testNoFullGC() throws Exception {
        ...
        */
        AbstractGCEvent<GCEvent> event1 = new GCEvent(0.0d, 511, 180, 1984, 0.0095672d, Type.GC);
        event1.getGeneration();
        AbstractGCEvent<GCEvent> event2 = new GCEvent(0.691d, 433, 233, 1984, 0.0056869d, Type.GC);
        event2.getGeneration();
        AbstractGCEvent<GCEvent> event3 = new GCEvent(1.030d, 745, 242, 1984, 0.0043429d, Type.GC);
        event3.getGeneration();
        AbstractGCEvent<GCEvent> event4 = new GCEvent(1.378d, 753, 452, 1984, 0.0094429d, Type.GC);
        event4.getGeneration();
        AbstractGCEvent<GCEvent> event5 = new GCEvent(2.499d, 964, 690, 1984, 0.0108058d, Type.GC);
        event5.getGeneration();
        AbstractGCEvent<GCEvent> event6 = new GCEvent(2.831d, 1202, 856, 1984, 0.0122599d, Type.GC);
        event6.getGeneration();
    ...
    public void testPrintGCDetails() throws Exception {
        ...
        */
        GCEvent event1 = new GCEvent(0.0d, 1534, 276, 16256, 0.0084272d, Type.GC);
        GCEvent childEvent1 = new GCEvent(0.0d, 1534, 128, 1664, 0.0082759d, Type.DEF_NEW);
        childEvent1.getGeneration();
        event1.add(childEvent1);
        event1.getGeneration();

        GCEvent event2 = new GCEvent(11.653d, 6560, 5492, 16256, 0.2858561d, Type.FULL_GC);
        GCEvent childEvent2 = new GCEvent(11.653d, 5634, 5492, 14592, 0.2856516d, Type.TENURED);
        event2.add(childEvent2);
        event2.getGeneration();

        GCEvent event3 = new GCEvent(22.879d, 16358, 9916, 16576, 0.8142078d, Type.GC);
        GCEvent childEvent3a = new GCEvent(22.879d, 1855, 125, 1856, 0.0099038d, Type.DEF_NEW);
        event3.add(childEvent3a);
        GCEvent childEvent3b = new GCEvent(22.889d, 14638, 9916, 14720, 0.8038262d, Type.TENURED);
        event3.add(childEvent3b);
        event3.getGeneration();

        GCEvent event4 = new GCEvent(31.788d, 17881, 13914, 18640, 0.8036514d, Type.FULL_GC);
        GCEvent childEvent4 = new GCEvent(31.788d, 16141, 13914, 16528, 0.8032950d, Type.TENURED);
